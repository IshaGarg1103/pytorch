...
class Encoder(nn.Module):
    ...
    def forward(self, src):
        embedded = self.dropout(self.embedding(src)) #src is the tensor of german token ids : shape(src length, batch size): [13, 128] , 13 tokens in each padded sentence, 128 sentences in the batch
